    ...
    for(int i = 0; i < 50; i++){
        if(pbullets[i].active){
            if (pbullets[i].hide) {
                ...
                shadowOAM[52 + i].attr1 = (0x1FF & pbullets[i].col) | (1<<14);
                shadowOAM[52 + i].attr2 = ((0)<<12) |
                    ((pbullets[i].curFrame * 2)*32+(pbullets[i].aniState * 2 + 5));
            }
        }
    }
}
    ...
    for(int i = 0; i < 50; i++){
        ...
        if(ebullets[i].active){
            if (ebullets[i].hide) {
                ...
                shadowOAM[2 + i].attr1 = (0x1FF & ebullets[i].col) | (1<<14);
                shadowOAM[2 + i].attr2 = ((0)<<12) |
                    ((ebullets[i].curFrame * 2)*32+(ebullets[i].aniState * 2 + 4));
            }
        }
    }
}
