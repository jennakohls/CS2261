...
#define ISBUFFER1 (REG_DISPCNT & BUFFER1FLAG)
...
extern u16 _currButton, _prevButton;

/* Functions */
void waitForVblank();
void flipPage();
void init_palette(const unsigned short *);
