...
obj_position:
	...
	strh	r3, [r0, #2]	@ movhi
	bx	lr
	.size	obj_position, .-obj_position
	.align	2
	.global	aff_rotation
	.syntax unified
	.arm
	.fpu softvfp
	.type	aff_rotation, %function
aff_rotation:
	@ Function supports interworking.
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
...
.L101:
	.word	sin_table
	.word	cos_table
	.size	aff_rotation, .-aff_rotation
	.align	2
	.global	aff_matrix
	.syntax unified
	.arm
	.fpu softvfp
	.type	aff_matrix, %function
aff_matrix:
	@ Function supports interworking.
	@ args = 4, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
