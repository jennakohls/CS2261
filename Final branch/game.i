...
void updatePlayer() {
    ...
    player.screenCol = (((player.pos.x) >> 16) - 8);
...
void drawPlayer() {
    ...
    if(player.health == 3){
    shadowOAM[102].attr0 = (0xFF & 153) | (1<<14);
    shadowOAM[102].attr1 = (0x1FF & 100) | (3<<14);
    shadowOAM[102].attr2 = ((0)<<12) | ((0)*32+(17));
    shadowOAM[103].attr0 = (0xFF & 153) | (1<<14);
    shadowOAM[103].attr1 = (0x1FF & 113) | (3<<14);
    shadowOAM[103].attr2 = ((0)<<12) | ((0)*32+(17));
    } else if(player.health == 2){
    shadowOAM[102].attr0 = (0xFF & 153) | (1<<14);
    shadowOAM[102].attr1 = (0x1FF & 100) | (2<<14);
    shadowOAM[102].attr2 = ((0)<<12) | ((0)*32+(17));
    shadowOAM[103].attr0 = (0xFF & 153) | (1<<14);
    shadowOAM[103].attr1 = (0x1FF & 120) | (2<<14);
    shadowOAM[103].attr2 = ((0)<<12) | ((0)*32+(17));
    } else if(player.health == 1){
    shadowOAM[103].attr0 |= (2<<8);
    shadowOAM[102].attr0 = (0xFF & 153) | (1<<14);
    shadowOAM[102].attr1 = (0x1FF & 98) | (2<<14);
    shadowOAM[102].attr2 = ((0)<<12) | ((0)*32+(17));
    }
