    ...
    if(enemy.atkState == 2){
        for(int i = 0; i < 50; i++){
            if(!ebullets[i].active){
                ...
                if(count == 0){
                    ebullets[i].row = (((player.pos.y) >> 16) - 16) + (2 * 16) + 16;
                    ebullets[i].col = (((player.pos.x) >> 16) - 8) + (0 * 16) + 16;
                } if(count == 1){
                    ebullets[i].row = (((player.pos.y) >> 16) - 16) + (1 * 16) + 16;
                    ebullets[i].col = (((player.pos.x) >> 16) - 8) + (1 * 16) + 16;
                } if(count == 2){
                    ebullets[i].row = (((player.pos.y) >> 16) - 16) + (0 * 16) + 16;
                    ebullets[i].col = (((player.pos.x) >> 16) - 8) + (2 * 16) + 16;
                } if(count == 3){
                    ebullets[i].row = (((player.pos.y) >> 16) - 16) + (-1 * 16) + 16;
                    ebullets[i].col = (((player.pos.x) >> 16) - 8) + (1 * 16) + 16;
                } if(count == 4){
