...
int main() {
	...
	while(1) {
        ...
        // shadowOAM[0].attr0 = (16 * pikachu.curFrame) | ATTR0_4BPP | ATTR0_SQUARE;
        // shadowOAM[0].attr1 = (pikachu.aniState * 16) | ATTR1_SMALL;
         shadowOAM[0].attr0 = (pikachu.row) | ATTR0_4BPP | ATTR0_SQUARE;
        shadowOAM[0].attr1 = (pikachu.col) | ATTR1_SMALL;
        shadowOAM[0].attr2 = ATTR2_TILEID(pikachu.curFrame * 2,
            pikachu.aniState * 2) | ATTR2_PALROW(0);
...
void initialize() {
    ...
    //REG_BG0CNT = BBG_4BPP | BG_CHARBLOCK(0) | BG_SCREENBLOCK(31);
    REG_BG0CNT = BG_SIZE_LARGE | BG_SCREENBLOCK(28) | BG_CHARBLOCK(0) | BG_4BPP;
