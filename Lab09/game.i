...
void updatePlayer() {
    ...
    if((~((*(volatile unsigned short *)0x04000130)) & ((1<<7)))) {
        if (pikachu.worldRow + pikachu.height < 256 &&
            (collisionmapBitmap[(pikachu.worldRow + pikachu.height) * 256 +
                pikachu.worldCol])
            && (collisionmapBitmap[(pikachu.worldRow + pikachu.height) * 256
                + (pikachu.worldCol + pikachu.width - pikachu.cdel)])
            ) {
            ...
            pikachu.worldRow = pikachu.worldRow + pikachu.rdel;
            if (
            vOff + 160 < 256 && pikachu.screenRow >= 160 / 2
                ) {
    ...
    if((~((*(volatile unsigned short *)0x04000130)) & ((1<<5)))) {
        if (pikachu.worldCol > 0
            && (collisionmapBitmap[pikachu.worldRow * 256
            + (pikachu.worldCol - pikachu.cdel)])
            && (collisionmapBitmap[(pikachu.worldRow + pikachu.height - pikachu.rdel) * 256
            + (pikachu.worldCol - pikachu.cdel)])
            ) {
    ...
    if((~((*(volatile unsigned short *)0x04000130)) & ((1<<4)))) {
        if (pikachu.worldCol + pikachu.width < 256
            ...
            pikachu.worldCol = pikachu.worldCol + pikachu.cdel;
            if (hOff + 240 < 256 && pikachu.screenCol >= 240 / 2
                ) {
